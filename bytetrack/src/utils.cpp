...
/**[rc]
 * @brief                           对花费矩阵进行线性分配
 * @param cost_matrix               花费矩阵
 * @param cost_matrix_size          花费矩阵的行大小
 * @param cost_matrix_size_size     花费矩阵的列大小
 * @param thresh                    阈值
 *
 */
	...
	bool extend_cost, float cost_limit, bool return_cost)
{
	...
	if (extend_cost || cost_limit < LONG_MAX)
	{
        ...
        //----------------------------------------
        // [rc] 对 cost_c_extended 进行赋值
        // [rc] 这个cost_c_extended矩阵的赋值被分为了四大块
        // [rc]                   |
        // [rc]           原矩阵  |   cost_limit / 2.0
        // [rc]                   |
        // [rc]         ----------|----------
        // [rc]                   |
        // [rc]  cost_limit / 2.0 |   0矩阵
        // [rc]                   |
        // [rc]
        // [rc] 如果cost_limit < LONG_MAX 的话, 则右上和左下的是 cost_limit / 2.0 元素构成的矩阵
        // [rc] 否则的话, 右上和左下的是 cost_c中最大的元素 + 1构成的矩阵
    ...
    //----------------------------------------
    // [rc] 进行匈牙利算法
    // [rc] x_c[i] 存储的是第i行指派的元素所在列
    // [rc] y_c[i] 存储的是第i列指派的元素所在行
